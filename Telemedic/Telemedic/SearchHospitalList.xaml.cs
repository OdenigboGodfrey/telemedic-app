...
namespace Telemedic
{
	...
	public partial class SearchHospitalList : ContentPage
	{
		public SearchHospitalList ()
		{
			InitializeComponent ();
            //_ParentStack.Children.Add(MedPractListTemplate.ListTemplate01(0, MedicalPractitionerType.Hospital, "St. David Hospital", "Lorem Ipsum tesx is ed focde le fill is  then sidede en the lasb fued", 4.5, Utilities.Source("icon_hospital.jpg", typeof(SearchHospitalList)), 4.0, "30 Wethral Rd, Owerri, Imo State."));
        }
        ...
        protected override async void OnAppearing()
        {
            ...
            {
                await AppointmentController.ListMedicalPractioner(_ParentStack, MedicalPractitionerType.Hospital);
            }
            else
            {
        ...
        {
            await AppointmentController.SearchMedicalPractioner(_MedPractName.Text, MedicalPractitionerType.Hospital, _ParentStack);
        }
